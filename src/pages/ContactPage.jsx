...
export default function ContactPage() {
  ...
  return (
    <div className="page contact-page">
      ...
      <div className="con-grid" style={{ maxWidth: '1400px', margin: '60px auto 0', width: 'calc(100% - 48px)' }}>

        {/* Left panel — info */}
        <div className="con-info" data-phone={g.phone || ''}>
          ...
          <div className="con-block">
            ...
            <a href={`tel:${g.phone}`} className="con-phone-big con-link">{g.phone}</a>
          </div>
          ...
          {g.whatsapp && (
            <a href={`https://wa.me/${g.whatsapp}`} target="_blank" rel="noopener noreferrer" className="con-wa">
              WhatsApp Us
            </a>
          )}
        </div>
        ...
        <div className="con-form">
          <h2 className="con-form-heading">Send a<br />Message.</h2>
      ...
      {/* Full-width dark map */}
      {g.mapEmbed && (
        <div className="con-map" style={{ marginTop: '4px' }}>
